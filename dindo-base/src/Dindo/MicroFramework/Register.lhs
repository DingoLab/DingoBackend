...
% src/Dindo/MicroFramework/Register.lhs
...
\begin{code}
module Dindo.MicroFramework.Register
    ( Registrable(..)
    , Heartbeatable(..)
    , register
    ) where
      ...
      import Dindo.MicroFramework.API
      import Dindo.MicroFramework.Destory
\end{code}
